...
| A2 | **Dither patterns** on Pencil/Brush/Bucket/Gradient (Bayer 2×2/4×4/8×8, checker, custom offset) | H | H | M | E J | Aseprite (gradient + bucket), PMNG, Piskel, Pyxel, Pixelorama, Pixaki (13 patterns), Resprite, Pixquare, Pixel Studio |
