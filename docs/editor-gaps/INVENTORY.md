...
|---|-----|----|----|--------|----------|-------------|
| ~~A1~~ | ~~**Symmetry / mirror drawing**~~ — **IMPLEMENTED 2026-09-05** (H · V · Both through a half-pixel axis; `docs/symmetry/DESIGN.md` + ADR 0026; diagonal + rotational deferred), unreleased | H | H | M–L | E J | Aseprite, PMNG (cyclic), Pixelorama, LibreSprite, rx, Piskel, Pixaki, Resprite, Pixquare, Pixel Studio, Pixilart |
...
| ~~A4~~ | ~~**Replace color**~~ — **IMPLEMENTED 2026-09-05** (swatch sheet "Replace in artwork…", tolerance + layer/frame/all scope), unreleased | H | H | S–M | E J | Aseprite, Piskel, GraphicsGale, Pixaki (cel/layer/project), Pixquare |
| ~~A5~~ | ~~**Outline**~~ — **IMPLEMENTED 2026-09-05** (tool tile: Side, Corners, Width 1–4, Apply), unreleased | H | H | S–M | E J | Aseprite, Pixelorama, Resprite (layer style), Pixquare, Pixel Studio, Dotpict |
...
| Symmetry / mirror painting | ✅ (2026-09-05, unreleased) | A1 |
| Dither brush / pattern paint | ✅ Patterns (1.9.0) | A2 |
| Alpha lock | ○ | A3 |
| Replace color | ✅ (2026-09-05, unreleased) | A4 |
| Outline | ✅ (2026-09-05, unreleased) | A5 |
